...
(defcustom template-date-format "%b %d %Y"
...
Return (REFINED . TEMPLATE) where REFINED is the refined version
of FULL and TEMPLATE and template file name, see
`template-derivation-alist'.  FULL is the initial file name given
by the user.  File name refinement is turned off when ARG is
non-nil.  If optional argument NO-DEFAULT is non-nil, return nil
instead (FULL \. \"~/.emacs.d./templates/DEFAULT.tpl\") if no
