...
syn match    ocamlHashErr    ">]"
syn match    ocamlParseErr   ":]"
syn match    ocamlQuotaErr   ">>"
...
syn cluster  ocamlAllErrs contains=ocamlBraceErr,ocamlBrackErr,ocamlParenErr,ocamlArrErr,ocamlHashErr,ocamlParseErr,ocamlCommentErr,ocamlCountErr,ocamlDoErr,ocamlEndErr,ocamlThenErr,ocamlQuotaErr

syn cluster  ocamlAENoParen contains=ocamlBraceErr,ocamlBrackErr,ocamlArrErr,ocamlHashErr,ocamlParseErr,ocamlCommentErr,ocamlCountErr,ocamlDoErr,ocamlDoneErr,ocamlEndErr,ocamlThenErr,ocamlQuotaErr
...
syn region   ocamlEncl transparent matchgroup=ocamlKeyword start="\[:" matchgroup=ocamlKeyword end=":\]" contains=ALLBUT,@ocamlContained,ocamlParseErr
syn region   ocamlEncl transparent matchgroup=ocamlKeyword start="\[<" matchgroup=ocamlKeyword end=">\]" contains=ALLBUT,@ocamlContained,ocamlHashErr
syn region   ocamlEncl transparent matchgroup=ocamlKeyword start="<\(\|:\w*\)<" matchgroup=ocamlKeyword end=">>" contains=ALLBUT,@ocamlContained,ocamlHashErr
...
" "for"
syn region   ocamlNone matchgroup=ocamlKeyword start="\<\(for\|reply\)\>" matchgroup=ocamlKeyword end="\<\(to\|downto\)\>" contains=ALLBUT,@ocamlContained,ocamlCountErr
...
syn keyword  ocamlKeyword  exception external functor fun function
...
syn keyword  ocamlKeyword  do try type
syn keyword  ocamlKeyword  value val virtual when while with
syn keyword  ocamlKeyword  def reply to spawn
...
if version >= 508 || !exists("did_ocaml_syntax_inits")
  ...
  HiLink ocamlHashErr      Error
  HiLink ocamlParseErr     Error
